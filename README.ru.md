...
Живой веб-интерфейс на реальной нагрузке — несколько харнесов, десятки
параллельных сессий, одна доска.

![Ростер сессий — все харнесы в одном списке](docs/assets/screenshots/01-sessions.png)
*Ростер: работающие агенты across воркспейсов, тумблеры автопилота,
длительности и композер сообщений.*

![Детали сессии — чат, автопилот, управление](docs/assets/screenshots/02-session-chat.png)
*Детали сессии: переписка, тумблер автопилота, stop/visualize и композер.*

![Статистика — реальные паттерны активности](docs/assets/screenshots/03-statistics.png)
*Статистика: 805 сессий в выборке, 11,1 тыс. write-событий, микс харнесов и
моделей, покрытие токенами и гистограммы объёма сессий.*
