...
export AGENT_RESUME_PYTHON=${AGENT_RESUME_PYTHON:-/usr/bin/python3}
export AGENT_RESUME_SCRIPT=${AGENT_RESUME_SCRIPT:-"${HOME}/agents-projects/agent-resume/agent_resume.py"}
...
exec "$node_bin" "${plugin_root}/dist/autopilot-runner.js" "$@"
